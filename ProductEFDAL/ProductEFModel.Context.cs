...
namespace ProductEFDAL
{
    ...
    public partial class ProductEntities : DbContext
    {
        ...
        public virtual int usp_AddNewProdcut(Nullable<int> slno, string pName, Nullable<int> pPrice)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_AddNewProdcut", slnoParameter, pNameParameter, pPriceParameter);
        }
    }
}
